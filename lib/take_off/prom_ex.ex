defmodule TakeOff.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule TakeOffWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :take_off

       ...

       plug PromEx.Plug, prom_ex_module: TakeOff.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: TakeOffWeb.Router, endpoint: TakeOffWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      {:take_off, "/grafana_dashboards/probando.json"}
    ]
  end
end
